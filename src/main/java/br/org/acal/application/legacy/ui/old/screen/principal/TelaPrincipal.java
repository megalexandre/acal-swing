package br.org.acal.application.legacy.ui.old.screen.principal;

import br.org.acal.application.legacy.ui.old.screen.cadastros.TelaCadastros;
import br.org.acal.application.legacy.ui.telas.ContasEditor;
import br.org.acal.application.legacy.ui.telas.GContas;
import br.org.acal.application.legacy.ui.telas.GContasAReceber;
import br.org.acal.application.legacy.ui.telas.GeradorUsuario.CriadorUsuario;
import br.org.acal.application.legacy.ui.telas.relatorios.TelaRelatoriosCheques;
import br.org.acal.application.legacy.ui.telas.relatorios.TelaRelatoriosContas;
import br.org.acal.application.legacy.ui.telas.relatorios.TelaRelatoriosEntradas;
import br.org.acal.application.legacy.ui.telas.relatorios.TelaRelatoriosSaidas;
import br.org.acal.application.legacy.ui.telas.relatorios.TelaRelatoriosSocios;
import br.org.acal.application.legacy.ui.telas.relatorios.tabelas.TelaTabelaCaixa;
import br.org.acal.application.legacy.ui.telas.relatorios.tabelas.TelaTabelaConta;
...
public class TelaPrincipal extends JFrame {
    ...
    private final DaoContasMensais daoContasMensais;

    private final TelaCadastros telaCadastros;

    private TrayIcon trayIcon = null;
    private SystemTray systemTray;

    public TelaPrincipal(
            DaoContasMensais daoContasMensais,
            TelaCadastros telaCadastros
    ) {
        this.daoContasMensais = daoContasMensais;
    ...
    private void startComponents() {
        DateTimeFormatter dateTimeFormatter = DateTimeFormatter.ofLocalizedDate(FULL).withLocale(
                Locale.of("pt", "BR")
        );
        ...
        jLabel1.setText(dateTimeFormatter.format(LocalDateTime.now()));

        ControlaEsc();
        setExtendedState(MAXIMIZED_BOTH);
        systemTray = SystemTray.getSystemTray();
        trayIcon = new TrayIcon(new ImageIcon(Objects.requireNonNull(getClass().getResource("/img/ico.png"))).getImage(), "Acal2000", popupMenu1);
    ...
    private void initComponents() {
        ...
        jMenuCobranca = new javax.swing.JMenuItem();
        ...
        jMenuCobranca.setText("Cobranças");
        jMenuCobranca.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuCobrancaActionPerformed(evt);
            }
        });
        jMenu4.add(jMenuCobranca);
    ...
    private void timer1OnTime(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_timer1OnTime
        DateTimeFormatter dateTimeFormatter = ofLocalizedDate(FULL)
                .withLocale(Locale.of("pt", "BR"));
        jLabel2.setText(dateTimeFormatter.format(LocalDateTime.now()));

    }//GEN-LAST:event_timer1OnTime


    private void jMenuItemFuncionariosActionPerformed(java.awt.event.ActionEvent evt) {
        telaCadastros.setVisible(true);
    }


    private void jMenuItemLogradourosActionPerformed(java.awt.event.ActionEvent evt) {
        telaCadastros.setVisible(true);
    }
    ...
    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
        ...
        tbc.setVisible(true);
        tbc.setExtendedState(MAXIMIZED_BOTH);
    ...
    private void timer2OnTime(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_timer2OnTime
        ...
        new Thread() {
            ...
            public void run() {
                ...
                List<Conta> contas = daoContasMensais.ContasVencidas(new Date(System.currentTimeMillis()));
                if (!contas.isEmpty()) {
    ...
    private void jMenuCobrancaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuCobrancaActionPerformed
       
        /*
        try {
            Connection conn = HibernateUtil.getConnection();

            JasperPrint jasper = JasperFillManager.fillReport(getClass().getResourceAsStream("/relatorios/rc_cobranca.jasper"), null, conn);
            JasperViewer.viewReport(jasper, false);
    ...
    }//GEN-LAST:event_jMenuCobrancaActionPerformed
    ...
    private javax.swing.JMenuItem jMenuCobranca;
