...
import br.org.acal.application.legacy.ui.table.CaixaCompletoTableModel;
import br.org.acal.resources.legacy.dao.DaoCaixaView;
import br.org.acal.resources.legacy.dao.DaoContaView;
import br.org.acal.resources.legacy.dao.DaoEnderecoView;
...
public class TelaTabelaConta extends JFrame {

    @Autowired
    private DaoContaView daoContaView;

    @Autowired
    private DaoSocioView daoSocioView;
   
    @Autowired
    private DaoEnderecoView daoEnderecoView;
    
    
    @Autowired
    private DaoCaixaView daoCaixaView;
    ...
    public void contar() {
        ...
        if (bdTela == null) {
            jValorTotalTela.setText(String.valueOf("0.00"));
        } else {
            jValorTotalTela.setText(String.valueOf(bdTela));
        }
        if (vdTela == null) {
            jValorAtrasadasTela.setText(String.valueOf("0.00"));
        } else {
            jValorAtrasadasTela.setText(String.valueOf(vdTela));
        }
        ...
        if (bdBanco == null) {
            jValorTotalbanco.setText("0.00");
        } else {
            jValorTotalbanco.setText(String.valueOf(bdBanco));
        }
        if (VdBanco == null) {
            jValorAtrasadasBanco.setText("0.00");
        } else {
            jValorAtrasadasBanco.setText(String.valueOf(VdBanco));
        }
    ...
    private void initComponents() {
        ...
        jCheckConsultarInativos = new javax.swing.JCheckBox();
        ...
        jCheckConsultarInativos.setText("Consultar Inativos");
        jCheckConsultarInativos.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCheckConsultarInativosActionPerformed(evt);
            }
        });
        ...
        jPanel9Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jCheckConsultarInativos))
            ...
            public void run() {
                ...
                if (pModelTela.getRowCount() < 1) {
                    ...
                    for (int i = 0; i < pModelTela.getRowCount(); i++) {
                        ...
                        if (pModelTela.getLinha(i).isSocioExclusivo()) {
                            existeCarne++;
                            if (existeCarne == 1) {
                        ...
                        dataConta.setTime(pModelTela.getLinha(i).getDate());
    ...
    private void jCheckBoxPagamentoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBoxPagamentoActionPerformed
        if (jCheckBoxPagamento.isSelected()) {
            ...
            jCheckConsultarInativos.setSelected(false);
    ...
    private void jCheckSocioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckSocioActionPerformed
        ...
        if (jCheckSocio.isSelected()) {
            ...
            if (jComboBoxSocio.getItemCount() == 0) {
                ...
                List<SociosView> socios = daoSocioView.BuscarTodosSociosView();
    ...
    private void jCheckLogradouroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckLogradouroActionPerformed
        ...
        if (jCheckLogradouro.isSelected()) {
            ...
            if (jComboBoxLogradouro.getItemCount() == 0) {
                ...
                List<EnderecoView> end = daoEnderecoView.BuscarTodosEnderecos();
    ...
    private void jCheckConsultarInativosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckConsultarInativosActionPerformed
        if (jCheckConsultarInativos.isSelected()) {
            travarComponentes();
        }

    }//GEN-LAST:event_jCheckConsultarInativosActionPerformed
    ...
    public void relatar(String relatorio, String sql, String tipoRelatorio) {
        ...
        try {
            ...
            JasperPrint jasper = JasperFillManager.fillReport(getClass().getResourceAsStream(relatorio), p, conn);
    ...
    public void buscar() {
        ...
        if (jCheckBoxPagamento.isSelected()) {
            ...
            if (jDatePagamentoInicio.getDate() == null) {
                ...
                pModelBanco.addListaDeConta(daoContaView.BuscarPagamento(jDatePagamentoInicio.getDate(), jDatePagamentoFim.getDate()));
                contar();
            }
            ...
            if (jDateVencimentoInicio.getDate() == null) {
                ...
                pModelBanco.addListaDeConta(daoContaView.BuscarVencimento(jDateVencimentoInicio.getDate(), jDateVencimentoFim.getDate()));
                contar();
            }
            ...
            switch (ativos) {
                ...
                case (checkSocio):
                    if (jComboBoxSocio.getSelectedIndex() == 0) {
                        ...
                        pModelBanco.addListaDeConta(daoCaixaView.BuscarSocioNome(jComboBoxSocio.getSelectedItem().toString()));
                        contar();
                    }
                    break;
                case (checkLogradouro):
                    if (jComboBoxLogradouro.getSelectedIndex() == 0) {
                        ...
                        pModelBanco.addListaDeConta(daoCaixaView.BuscarLogradouro(jComboBoxLogradouro.getSelectedItem().toString()));
                        contar();
                    }
                    break;
                case (checkStatus):
                    if (jComboBoxStatus.getSelectedIndex() == 0) {
                        ...
                        pModelBanco.addListaDeConta(daoCaixaView.BuscarStatus(aberta));
                    } else if (jComboBoxStatus.getSelectedIndex() == 2) {
                        pModelBanco.addListaDeConta(daoCaixaView.BuscarStatus(paga));
                    } else if (jComboBoxStatus.getSelectedIndex() == 3) {
                        pModelBanco.addListaDeConta(daoCaixaView.BuscarStatus(vencida));
                    }
                    contar();
                    break;
                case (checkSocio_logradouro):
                    ...
                    if (jComboBoxSocio.getSelectedIndex() == 0) {
                        ...
                        pModelBanco.addListaDeConta(daoCaixaView.BuscarSocioLogradouro(jComboBoxLogradouro.getSelectedItem().toString(), jComboBoxSocio.getSelectedItem().toString()));
                        contar();
                    }
                    break;
                case (checkSocio_status):
                    ...
                    if (jComboBoxSocio.getSelectedIndex() == 0) {
                        ...
                        if (jComboBoxStatus.getSelectedIndex() == 0) {
                            ...
                            pModelBanco.addListaDeConta(daoCaixaView.BuscarSocioStatus(aberta, jComboBoxSocio.getSelectedItem().toString()));
                        } else if (jComboBoxStatus.getSelectedIndex() == 2) {
                            pModelBanco.addListaDeConta(daoCaixaView.BuscarSocioStatus(paga, jComboBoxSocio.getSelectedItem().toString()));
                        } else if (jComboBoxStatus.getSelectedIndex() == 3) {
                            pModelBanco.addListaDeConta(daoCaixaView.BuscarSocioStatus(vencida, jComboBoxSocio.getSelectedItem().toString()));
                        }
                        contar();
                    }
                    break;
                case (checkLogradouro_status):
                    ...
                    if (jComboBoxLogradouro.getSelectedIndex() == 0) {
                        ...
                        if (jComboBoxStatus.getSelectedIndex() == 0) {
                            ...
                            pModelBanco.addListaDeConta(daoCaixaView.BuscarLogradouroStatus(aberta, jComboBoxLogradouro.getSelectedItem().toString()));
                        } else if (jComboBoxStatus.getSelectedIndex() == 2) {
                            pModelBanco.addListaDeConta(daoCaixaView.BuscarLogradouroStatus(paga, jComboBoxLogradouro.getSelectedItem().toString()));
                        } else if (jComboBoxStatus.getSelectedIndex() == 3) {
                            pModelBanco.addListaDeConta(daoCaixaView.BuscarLogradouroStatus(vencida, jComboBoxLogradouro.getSelectedItem().toString()));
                        }
                        contar();
                    }
                    break;
                case (check_todas):
                    ...
                    if (jComboBoxLogradouro.getSelectedIndex() == 0) {
                        ...
                        if (jComboBoxStatus.getSelectedIndex() == 1) {
                            pModelBanco.addListaDeConta(daoCaixaView.BuscarTodosCriterios(aberta, jComboBoxSocio.getSelectedItem().toString(), jComboBoxLogradouro.getSelectedItem().toString()));
                        } else if (jComboBoxStatus.getSelectedIndex() == 2) {
                            pModelBanco.addListaDeConta(daoCaixaView.BuscarTodosCriterios(paga, jComboBoxSocio.getSelectedItem().toString(), jComboBoxLogradouro.getSelectedItem().toString()));
                        } else if (jComboBoxStatus.getSelectedIndex() == 3) {
                            pModelBanco.addListaDeConta(daoCaixaView.BuscarTodosCriterios(vencida, jComboBoxSocio.getSelectedItem().toString(), jComboBoxLogradouro.getSelectedItem().toString()));
                        }
                        contar();
                    }
                    break;
    ...
    public void cobraças() {
        pModelTela.limpar();
        pModelBanco.limpar();
        pModelBanco.addListaDeConta(daoContaView.BuscarContasAtrasadas60());
    ...
    private javax.swing.JCheckBox jCheckConsultarInativos;
