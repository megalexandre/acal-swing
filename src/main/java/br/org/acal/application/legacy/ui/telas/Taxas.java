 ...
 private List<Taxa> valoresTaxas;
   ...
   public List<Taxa> getValoresTaxas(){
    ...
    private void carregarCampos(){
        ...
        List<Taxa> ends = daoTaxa.TaxasTodas();
        ...
        switch(valoresTaxas.size()){
            case 1 -> setSelectedCombos(1);
            case 2 -> setSelectedCombos(2);
            case 3 -> setSelectedCombos(3);
            case 4 -> setSelectedCombos(4);
            case 5 -> setSelectedCombos(5);
            case 6 -> setSelectedCombos(6);
            case 7 -> setSelectedCombos(7);
            case 8 -> setSelectedCombos(8);
        }
    }
          ...
          if(!comboAtual.getSelectedItem().equals("")){
            ...
            if(op == JOptionPane.YES_OPTION){
                ...
                try{
                   ...
                   Taxa t = daoTaxa.TaxasPorNome((String)comboAtual.getSelectedItem());
