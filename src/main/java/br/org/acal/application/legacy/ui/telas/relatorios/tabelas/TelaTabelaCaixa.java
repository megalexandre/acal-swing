...
import br.org.acal.application.legacy.ui.table.CaixaTableModel;
...
public class TelaTabelaCaixa extends javax.swing.JFrame {
    ...
    private void jButtonAtualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAtualizarActionPerformed
        ...
        if (jDateFim.getDate().before(jDateInicio.getDate())) {
            jDateFim.setDate(jDateInicio.getDate());
        } else {
            SimpleDateFormat f1 = new SimpleDateFormat("yyyy-MM-dd");
            SimpleDateFormat f2 = new SimpleDateFormat("dd-MM-yyyy");

            pModel.limpar();
            pModel.addListaDeCaixa(daoCaixaView
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        pModel.addListaDeCaixa(daoCaixaView.BuscarTodosCaixaViewDatePagamento((new Date()), (new Date())));
        AtualizarAjuda(null, null);

        if (daoCaixaView.BuscarTodosCaixaViewDatePagamento((new Date()), (new Date())).isEmpty()) {
    ...
    private void jButtonExportarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExportarActionPerformed
        ...
        if ((jDateInicio.getDate() == null || jDateInicio.getDate() == null)) {
            JOptionPane.showMessageDialog(null, "É preciso Escolher as Datas e atualizar antes de Exportar");
        } else if (jTableCaixa.getRowCount() == 0) {
            JOptionPane.showMessageDialog(null, "É preciso possuir dados para usar essa opção");
        } else {
