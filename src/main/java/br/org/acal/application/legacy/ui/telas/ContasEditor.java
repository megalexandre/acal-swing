...
public class ContasEditor extends javax.swing.JFrame {
    ...
    private void jButtonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarActionPerformed
        ...
        if(jCheckLogradouro.isSelected() || jCheckSocio.isSelected() || jCheckStatus.isSelected()){
            ...
            case(checkSocio):
                ...
                pModel.addListaDeConta(daoCaixaView.BuscarSocioNome(jComboBoxSocio.getSelectedItem().toString()));
                }
                break;
            case(checkLogradouro):
                ...
                pModel.addListaDeConta(daoCaixaView.BuscarLogradouro(jComboBoxLogradouro.getSelectedItem().toString()));
                }
                break;
            case(checkStatus):
                if  (jComboBoxStatus.getSelectedIndex()==0){
                    ...
                    pModel.addListaDeConta(daoCaixaView.BuscarStatus(aberta));
                }
                else if (jComboBoxStatus.getSelectedIndex()==2){
                    pModel.addListaDeConta(daoCaixaView.BuscarStatus(paga));
                }
                else if (jComboBoxStatus.getSelectedIndex()==3){
                    pModel.addListaDeConta(daoCaixaView.BuscarStatus(vencida));
                }
                break;
            case(checkSocio_logradouro):
                ...
                if(jComboBoxSocio.getSelectedIndex()==0){
                   ...
                   pModel.addListaDeConta(daoCaixaView.BuscarSocioLogradouro(jComboBoxLogradouro.getSelectedItem().toString(),jComboBoxSocio.getSelectedItem().toString()));
                ...
                if(jComboBoxSocio.getSelectedIndex()==0){
                   ...
                   jComboBoxSocio.requestFocus();
                    ...
                    if (jComboBoxStatus.getSelectedIndex()==0){
                        ...
                        pModel.addListaDeConta(daoCaixaView.BuscarSocioStatus(aberta, jComboBoxSocio.getSelectedItem().toString()));
                    }
                    else if(jComboBoxStatus.getSelectedIndex()==2){
                         pModel.addListaDeConta(daoCaixaView.BuscarSocioStatus(paga, jComboBoxSocio.getSelectedItem().toString()));
                    }
                    else if(jComboBoxStatus.getSelectedIndex()==3){
                         pModel.addListaDeConta(daoCaixaView.BuscarSocioStatus(vencida, jComboBoxSocio.getSelectedItem().toString()));
                    }
                ...
                if(jComboBoxLogradouro.getSelectedIndex()==0){
                   ...
                   jComboBoxLogradouro.requestFocus();
                    ...
                    if     (jComboBoxStatus.getSelectedIndex()==0){
                        ...
                        pModel.addListaDeConta(daoCaixaView.BuscarLogradouroStatus(aberta, jComboBoxLogradouro.getSelectedItem().toString()));
                    }
                    else if(jComboBoxStatus.getSelectedIndex()==2){
                        pModel.addListaDeConta(daoCaixaView.BuscarLogradouroStatus(paga, jComboBoxLogradouro.getSelectedItem().toString()));
                    }
                    else if(jComboBoxStatus.getSelectedIndex()==3){
                        pModel.addListaDeConta(daoCaixaView.BuscarLogradouroStatus(vencida, jComboBoxLogradouro.getSelectedItem().toString()));
                    }
                }
                break;
            case(check_todas):
                ...
                if(jComboBoxLogradouro.getSelectedIndex()==0){
                    ...
                    if(jComboBoxStatus.getSelectedIndex()==1){
                        pModel.addListaDeConta(daoCaixaView.BuscarTodosCriterios(aberta, jComboBoxSocio.getSelectedItem().toString(), jComboBoxLogradouro.getSelectedItem().toString()));
                    }
                    else if(jComboBoxStatus.getSelectedIndex()==2){
                        pModel.addListaDeConta(daoCaixaView.BuscarTodosCriterios(paga, jComboBoxSocio.getSelectedItem().toString(), jComboBoxLogradouro.getSelectedItem().toString()));
                    }
                    else if(jComboBoxStatus.getSelectedIndex()==3){
                        pModel.addListaDeConta(daoCaixaView.BuscarTodosCriterios(vencida, jComboBoxSocio.getSelectedItem().toString(), jComboBoxLogradouro.getSelectedItem().toString()));              
                    }
                }
                break;
            }
    ...
    private void jCheckLogradouroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckLogradouroActionPerformed
        ...
        if(jComboBoxLogradouro.getItemCount() == 0){
            ...
            List<EnderecoView> enderecos= daoEnderecoView.BuscarTodosEnderecos();
